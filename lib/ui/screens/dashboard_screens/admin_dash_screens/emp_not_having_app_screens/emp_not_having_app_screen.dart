...
class EmpNotHavingAppScreen extends StatelessWidget {
  const EmpNotHavingAppScreen({Key? key}) : super(key: key);
            ...
            children: [
              ...
              if (_controller.isLoading) ...[
                const Expanded(child: LoadingWidget()),
                  ...
                  .filteredEmpNotHavingAppList.isNotEmpty) ...[
                verticalSpace12,
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemCount: _controller.filteredEmpNotHavingAppList.length,
                    itemBuilder: (context, _position) {
                      final Employee _employee =
                          _controller.filteredEmpNotHavingAppList[_position];

                      final int _itemCount =
                          _controller.filteredEmpNotHavingAppList.length > 15
                              ? 15
                              : _controller.filteredEmpNotHavingAppList.length;
