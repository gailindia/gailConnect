...
class DispensaryHistory extends StatelessWidget {
  const DispensaryHistory({Key? key}) : super(key: key);
                ...
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder:
                      ...
                      //       ]),
                      return _dispensaryData.status.toString() == "Processed" || _dispensaryData.status.toString() == "Received" || _dispensaryData.status.toString() == "Processing" || _dispensaryData.status.toString() == "OUT FOR DELIVERY" || _dispensaryData.status.toString == "CANCELLED" || (_dispensaryData.acknowledgebyuser == null && _dispensaryData.status.toString() == "Delivered")? Container():
                          ...
                          children: [
                                ...
                                Padding(
                                  ...
                                  child: Padding(
                                    ...
                                    child: RichTextWidget(
                                      ...
                                      description:
                                          _dispensaryData.sno.toString().isEmpty
                                              ? ""
                                              : _dispensaryData.sno!,
                                                  // .toStringAsFixed(0),
                            ...
                            children: [
                              _dispensaryData.status
                                  == null ? Text("") : Text(_dispensaryData.status.toString()),
                              Icon(Icons.circle,color: _dispensaryData.acknowledgebyuser.toString() == "1" ?(_dispensaryData.status.toString() == "Cancelled" ? colorController.kPrimaryColor : colorController.kPrimaryColor) : (_dispensaryData.acknowledgebyuser.toString() == "0" ? colorController.kPrimaryColor : colorController.kPrimaryColor))
                            ],
                          ),
                            ...
                            _dispensaryData.invoiceno.toString().isEmpty || _dispensaryData.invoiceno.toString() == "null" ? Text("" ) :
                            Padding(
                              padding: EdgeInsets.all(0),
                              child: Column(
                                children: [
                                    ...
                                    child: Row(
                                      children: [
                                        Padding(
                                          ...
                                          child: Text(_dispensaryData.empno!.isEmpty
                                              ? "null"
                                              : "Bill No. : "+_dispensaryData.invoiceno.toString(),style: TextStyle(
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Text(_dispensaryData.invoicedetails!.isEmpty
                                              ? "null"
                                              : "Amount: " + _dispensaryData.invoicedetails!,style: TextStyle(
                                              fontWeight: FontWeight.w600,fontSize: 12
                                          ),),
                                        ),
                                        // Spacer(),
                            ...
                            Row(
                              ...
                              children: [
                                    ...
                                    child: SizedBox(
                                      child: ElevatedButton(
                                        ...
                                        style: ElevatedButton.styleFrom(
                                          shape: const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10))), backgroundColor: colorController.kPrimaryDarkColor,
                                          elevation: 5,
                                ...
                                //       clipBehavior: Clip.antiAlias,
                                //       onPressed: ()=>{
                                //         if(_dispensaryData.status.toString() == "Processed" || _dispensaryData.status.toString() == "Received" || _dispensaryData.status.toString() == "Processing"){
                                //           _showInfoDialogCancel(context,_controller,_dispensaryData.sno!),
                                //         }
                                //
                                //       },
                                //       style: ElevatedButton.styleFrom(
                                //         shape: const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10))),
                                //         primary: _dispensaryData.status.toString() == "Processed" || _dispensaryData.status.toString() == "Received" || _dispensaryData.status.toString() == "Processing" && _dispensaryData.cancelleationstatus == null ? colorController.kPrimaryDarkColor : kDarkGreyColor,
                                //         elevation: 5,
                                //         visualDensity: VisualDensity.adaptivePlatformDensity,
                                //       ),
                                ...
                                //       style: ElevatedButton.styleFrom(
                                //         shape: const RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10))),
                                //         primary: _dispensaryData.status.toString() == "Delivered" ?colorController.kPrimaryDarkColor : kDarkGreyColor,
                                //         elevation: 2,
                                //         visualDensity: VisualDensity.adaptivePlatformDensity,
                                //       ),
      ...
      children: <Widget>[
        GetBuilder<DispensaryHistoryController>(
          builder: (_controller) => Radio(
              ...
              onChanged: (value) =>
                  _controller.onClickRadioButton(value)),
        ),
        Text(title)
      ],
    );
  ...
  Future<void> _showInfoDialog(BuildContext context, DispensaryHistoryController controller, String sno, String? acknowledgebyuser) {
    ColorController colorController = Get.put(ColorController());
                ...
                Row(
                  children: [
                    Padding(
                      ...
                      child: Text("Receipt Acknowledgement",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 16),),
                    ),
                    Spacer(),
                    GestureDetector(
                        onTap: (){
                ...
                child: Expanded(
                  ...
                  child: Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        shape:  RoundedRectangleBorder(borderRadius: BorderRadius.all(Radius.circular(10))), backgroundColor: colorController.kPrimaryDarkColor,
                        elevation: 5,
                        visualDensity: VisualDensity.adaptivePlatformDensity,
                      ),
  ...
  _showInfoDialogCancel(BuildContext context, DispensaryHistoryController controller, String SNO) {
    return showDialog<void>(
      context: context,
      builder: (BuildContext context) {
        int selectedRadio = 0;
