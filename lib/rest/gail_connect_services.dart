...
class GailConnectServices extends ApiServices {
  ...
  Future<String> getGuestHouseDetailsApi() async {
    SecureSharedPref pref = await SecureSharedPref.getInstance();
    String? s = await pref.getString("token", isEncrypted: true);
  ...
  Future<String> getHospitalsCitiesListApi() async {
    SecureSharedPref pref = await SecureSharedPref.getInstance();
    String? s = await pref.getString("token", isEncrypted: true);
  ...
  Future<String> getOfficesListApi() async {
    SecureSharedPref pref = await SecureSharedPref.getInstance();
    String? s = await pref.getString("token", isEncrypted: true);
  ...
  Future<String> getControlRoomListApi() async {
    SecureSharedPref pref = await SecureSharedPref.getInstance();
    String? s = await pref.getString("token", isEncrypted: true);
  ...
  downloadImage({required String imageUrl}) async {
    try {
      ...
      if (_response.statusCode == 200) {
        ...
        // Share the file
          // Convert file path to XFile and share
